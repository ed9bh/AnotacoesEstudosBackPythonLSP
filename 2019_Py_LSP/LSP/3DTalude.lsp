...
(defun elevPoint (Point Vlao / EPoint)
  ...
  (defun main ()
    (add_layer ConvencaoLayer 252 "Continuous")
    (setq
    ...
    (while
      ...
      (if
        TracoProjecao
        (progn
          (vla-put-layer TracoProjecao ConvencaoLayer)
          (vla-put-color TracoProjecao acByLayer)
        )
      )
